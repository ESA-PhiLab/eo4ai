...
"""Script for transforming original datasets to OCMARTA format."""
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('dataset',
                            help='Name of dataset class. Check datasets.py for options.')
    ...
    arg_parser.add_argument('-o', '--overwrite', action='store_true',
                            help='Allows overwrite of an existing output directory.')
    ...
    arg_parser.add_argument('-b', '--selected_band_ids', type=literal_eval,
                            help='List of bands to be used, defined as list of band_ids.',
                            default=None)
    ...
    arg_parser.add_argument('-g', '--generate_metadata', action='store_true',
                            help='Whether to generate a metadata file for each image/mask pair')
    # TODO: Implement optional descriptors output
    # arg_parser.add_argument('-d', '--generate_descriptors', action='store_true',
    #                         help='Whether to generate spectral descriptors for each image/mask pair')
    arg_parser.add_argument('-j', '--jobs', type=int,
                            help='How many parallel jobs should be used to process the data.',
                            default=4)
    #
    #
